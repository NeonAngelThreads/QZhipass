...
MERGE INTO models (model_id, model_name, api_base, api_key, create_at)
    KEY (model_id)
    VALUES
    (1, 'deepseek-chat',  'https://api.deepseek.com/v1', 'local-development-placeholder', CURRENT_TIMESTAMP),
    (2, 'deepseek-v4',    'https://api.deepseek.com/v1', 'local-development-placeholder', CURRENT_TIMESTAMP);

...
class EmailBindingControllerTests {
    ...
    @Test
    void rejectsUnauthenticatedStatusRequest() throws Exception {
    ...
    @Test
    void returnsEmailBindingStatusContract() throws Exception {
    ...
    @Test
    void acceptsSendCodeContract() throws Exception {
        when(currentUserService.requireUserId(any())).thenReturn(1001L);
    ...
    @Test
    void returnsStructuredCooldownResponse() throws Exception {
        when(currentUserService.requireUserId(any())).thenReturn(1001L);
        when(emailBindingService.sendCode(1001L, "tester@example.com"))
                .thenThrow(new EmailBindingCooldownException(37L));
        ...
        mockMvc.perform(post("/api/v1/account/email-binding/code")
                ...
                .andExpect(jsonPath("$.success").value(false))
                .andExpect(jsonPath("$.data.cooldownSeconds").value(37));
    }

    @Test
    void acceptsVerifyContract() throws Exception {
        when(currentUserService.requireUserId(any())).thenReturn(1001L);
    ...
    @Test
    void returnsReadableValidationMessage() throws Exception {
        when(currentUserService.requireUserId(any())).thenReturn(1001L);
